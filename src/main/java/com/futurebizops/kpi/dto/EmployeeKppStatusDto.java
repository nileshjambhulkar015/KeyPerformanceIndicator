...
public class EmployeeKppStatusDto {
    ...
    public EmployeeKppStatusDto(Object[] objects) {
        ...
        employeeKppMasterDto.setTotalEmpAchivedWeight(String.valueOf(objects[13]));
        employeeKppMasterDto.setTotalEmpOverallAchieve(String.valueOf(objects[14]));
        employeeKppMasterDto.setTotalEmpOverallTaskComp(String.valueOf(objects[15]));
