...
public class ComplaintController {
    ...
    public ResponseEntity<KPIResponse> saveComplaint(@RequestBody ComplaintCreateRequest complaintCreateRequest) {
        log.info("Inside ComplaintController >> saveComplaint() complaintCreateRequest : {}", complaintCreateRequest);
    ...
    public ResponseEntity<KPIResponse> updateEmployeeComplaint(@RequestBody EmployeeComplaintUpdateRequest complaintUpdateRequest) {
        log.info("Inside ComplaintController >> updateEmployeeComplaint() complaintUpdateRequest : {}", complaintUpdateRequest);
    ...
    public ResponseEntity<KPIResponse> deleteEmployeeDetails(@RequestParam(required = false) Integer empCompId) {
        log.info("Inside ComplaintController >> deleteEmployeeComplaint() empCompId : {}", empCompId);
    ...
    public ResponseEntity<KPIResponse> updateEmpAssignComplaintHimself(@RequestBody EmployeeComplaintUpdateRequest complaintUpdateRequest) {
        log.info("Inside ComplaintController >> updateEmpAssignComplaintHimself() complaintUpdateRequest : {}", complaintUpdateRequest);
    ...
    public ResponseEntity<KPIResponse> findComplaintDetails(
        ...
        log.info("Inside ComplaintController >> findComplaintDetails() empId : {}, compId : {}, roleId: {}, deptId :{}, compDesc : {}, compStatus : {}, compTypeDeptId: {}, resolveEmpId : {}", empId, compId, roleId, deptId, compDesc, compStatus, compTypeDeptId, resolveEmpId);
    ...
    public ResponseEntity<KPIResponse> advSearchEmployeeComplaintDetails(@RequestBody ComplaintAdvSearch complaintAdvSearch, @Parameter(hidden = true) Pageable pageable) {
        log.info("Inside ComplaintController >> advSearchEmployeeComplaintDetails() complaintUpdateRequest : {}", complaintAdvSearch);
    ...
    public KPIResponse downloadEmployeeComplaints(HttpServletResponse httpServletResponse,
        ...
        log.info("Inside ComplaintController >> downloadEmployeeComplaints() compFromDate : {}, compToDate : {}, empId : {}, empCompDeptId: {}, asCompTypeDeptId : {}, empCompId : {}", compFromDate, compToDate, empId, empCompDeptId, asCompTypeDeptId, empCompId);
    ...
    public ResponseEntity<Object> findAllEmployeeCompById(@RequestParam(required = false) Integer empCompId) {
        log.info("Inside ComplaintController >> findAllEmployeeCompById() empCompId : {}", empCompId);
