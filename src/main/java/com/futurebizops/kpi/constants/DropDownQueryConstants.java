...
public final class DropDownQueryConstants {
    ...
    public static final String DD_SITE_FROM_COMPANY_QUERY = "select distinct cm.site_id,si.site_name,si.status_cd from company_master cm, site si where si.site_id  = cm.site_id  and si.status_cd = 'A' and cm.region_id  = coalesce(:regionId,cm.region_id)";
