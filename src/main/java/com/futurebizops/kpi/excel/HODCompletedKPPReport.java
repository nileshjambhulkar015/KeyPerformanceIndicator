...
@Service
public class HODCompletedKPPReport {
    ...
    public void getHodKppStatusExport(EmpKppStatusResponse response, HttpServletResponse httpServletResponse) {
        ...
        for (EmployeeKppDetailsDto employeeKppDetailsDto : kppDetails) {
            ...
            cell12.setCellValue(employeeKppDetailsDto.getGmOverallAchieve());
        ...
        //    overallCumulativeRatingsPer+=avgRatingsPercentage;
            ...
            Cell cell17 = kppRow.createCell(16);
            ...
            Cell cell18 = kppRow.createCell(17);
            ...
            Cell cell19 = kppRow.createCell(18);
            ...
            Cell cell20 = kppRow.createCell(19);
      ...
      //  Double avgTotalEmpAchiveWeight =Double.parseDouble(response.getTotalEmpAchivedWeight()) / totalKpp;
       ...
       // httpServletResponse.setContentType("application/vnd.openxmlformats-officedocument.spreadsheetml.sheet");
        httpServletResponse.setHeader("Content-Disposition", "attachment; filename=" + response.getEmpEId() + "-" + DateTimeUtils.extractMonthName(response.getReportKppMonth()) + "-"+ DateTimeUtils.extractYear(response.getReportKppMonth())+".xlsx");
...
// for header of hod kpp


    private String getHodHeaderCellValue(int columnIndex) {
        String Header = "";
        switch (columnIndex) {
            case 0:
                Header = "Sr.No";
