...
public void getHodKppStatusExport(EmpKppStatusResponse response, HttpServletResponse httpServletResponse) {
    ...
    for (EmployeeKppDetailsDto employeeKppDetailsDto : kppDetails) {
        ...
        Cell cell17 = kppRow.createCell(14);
        ...
        Cell cell18 = kppRow.createCell(15);
    ...
    private String getHodHeaderCellValue(int columnIndex) {
        ...
        switch (columnIndex) {
            ...
            case 9:
                ...
                break;
            case 10:
                Header = "HOD OverAll Weightage In%";
                break;
            case 11:
