...
public interface ComplaintService {
    ...
    public KPIResponse findComplaintDetails(Integer empId, String compId,Integer roleId,Integer deptId,String compDesc, String compStatus, String statusCd, Pageable pageable);
