...
public interface ComplaintRepo extends JpaRepository<ComplaintEntity, Integer> {
    ...
    List<Object[]> getEmployeeComplaintDetail(@Param("empId") Integer empId, @Param("compId") String compId,@Param("roleId") Integer roleId,@Param("deptId") Integer deptId,@Param("compTypeName") String compTypeName,@Param("compStatus") String compStatus, @Param("statusCd") String statusCd, @Param("sortName") String sortName, @Param("pageSize") Integer pageSize, @Param("pageOffset") Integer pageOffset);

    @Query(value = SQLQueryConstants.EMPLOYEE_COMPLAINT_COUNT_UERY, nativeQuery = true)
    Integer getEmployeeComplaintCount(@Param("empId") Integer empId, @Param("compId") String compId,@Param("roleId") Integer roleId,@Param("deptId") Integer deptId, @Param("compTypeName") String compTypeName,@Param("compStatus") String compStatus, @Param("statusCd") String statusCd);
